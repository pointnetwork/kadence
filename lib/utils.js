...
module.exports.eqsolve = function(input, opts = constants.IDENTITY_DIFFICULTY) {
  ...
  return new Promise(function(resolve, reject) {
    console.error('Equihash/Eclipse plugin for Kadence is disabled in this repository');
    console.error('because it was not needed and took time to compile from C++. Enable it');
    console.error('back in the source code, or better yet, replace by another module.');
    process.exit(1);
