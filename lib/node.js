...
Node.prototype.connect = function(contact, callback) {
  // TODO: Since we can now disconnect and close the transport, we need to make
  // TODO: sure that the transport is active before proceeding. If the
  // TODO: transport adapter has been closed, we must reopen it.
 ...
 * routing table
 * @param {Function} callback - Optional callback on disconnect
 */
Node.prototype.disconnect = function(callback) {
  // TODO: Close the transport adapter
  // TODO: Empty the routing table
...
Node.prototype._bindRouterEventHandlers = function() {
  // TODO: Listen for router events to determine the size of the routing table
  // TODO: so we can determine if we have joined or left the overlay
};
